...
class _HomePageState extends State<HomePage> {
  ...
  Widget _topBarWidget(){
    return SizedBox(height: _deviceHeight *0.12,
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,mainAxisSize: MainAxisSize.max,crossAxisAlignment: CrossAxisAlignment.center,children: <Widget>[
        Icon(
          Icons.menu,
          color: Colors.white,
          size: 30,
            ...
            //  SizedBox(height: _deviceHeight*0.0),
              Row(
                ...
                children: featuredGames.map((_game){
                  ...
                  double _circleRadius=_deviceHeight*0.003;
                  return Container(
